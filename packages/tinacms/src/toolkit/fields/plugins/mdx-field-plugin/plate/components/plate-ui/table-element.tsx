...
export const TableBordersDropdownMenuContent = () => {
  return <div>TableBordersDropdownMenuContent</div>;
};
...
export const TableFloatingToolbar = () => {
  return <div>TableFloatingToolbar</div>;
};
