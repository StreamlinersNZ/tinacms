'use client';
import type { SlateJsonQuery } from '@/tina/__generated__/types';
...
export default function SlateJsonPost(props: ClientPageProps) {
  ...
  return (
    <>
      <TinaMarkdown
        data-tina-field={tinaField(data.slateJson, 'body')}
        content={data.slateJson.body}
        components={components}
      />
      <code>
        <pre>{JSON.stringify(data.slateJson, null, 2)}</pre>
      </code>
    </>
  );
}
